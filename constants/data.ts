  ...
  offices: [
    {
      label: 'Head Office',
      address:
        'The Atrium, Office No. B -105a, 1 Floor, Shirke Road, Mundhwa, Pune 411036',
    },
    {
      label: 'Mumbai Branch',
...
export const FEATURES: FeatureItem[] = [
  {
    ...
    description:
      'Enterprise-grade security built into the core of every platform we deliver.',
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      'Flexible architectures that grow with your business — from pilot to global rollout.',
  },
  {
    icon: Lightbulb,
    title: 'Better Decisions',
    description:
      'Real-time analytics and insights for confident, data-driven choices.',
  },
];
...
export const CASE_STUDIES: CaseStudyItem[] = [
  ...
  },
  {
    ...
    solution:
      'We unified HVAC, lighting, and energy metering under our BMS platform with occupancy-driven schedules, predictive maintenance, and a single operations dashboard.',
    results: [
  ...
  },
  {
    ...
    challenge:
      'A manufacturing firm could not reliably track high-value tooling and mobile assets across its multi-acre plant.',
    solution:
      'We deployed BLE + LoRaWAN tags on critical assets and built a custom IoT platform with real-time location, condition monitoring, and predictive maintenance alerts.',
    results: [
